    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def async_wrapper(*args, **kwargs) -> JSONResponse:
            try:
                ...
                # 응답 생성
                return ResponseFactory.success(data=result, message=message)
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            for arg in args:
                if isinstance(arg, Request):
                    ...
                    if hasattr(arg, "query_params"):
                        ...
                        per_page = min(
                            int(arg.query_params.get(per_page_param, default_per_page)),
                            max_per_page,
                        )
                    break
            ...
            return ResponseFactory.paginated(
                data=data, page=page, per_page=per_page, total=total, request=request
            )
